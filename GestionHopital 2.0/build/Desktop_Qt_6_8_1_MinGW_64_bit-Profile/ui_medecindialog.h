...
public:
    ...
    void setupUi(QWidget *MedecinDialog)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/ajouter.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/modifier.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/supprimer.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        if (tableWidgetMedecins->columnCount() < 6)
    ...
    void retranslateUi(QWidget *MedecinDialog)
    {
        ...
        tableWidgetMedecins->setProperty("horizontalHeaderLabels", QVariant(QStringList{
